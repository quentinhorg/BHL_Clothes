...
1) Télécharger la  [dernière version](https://github.com/quentinhorg/BHL_Clothes/releases/latest) du site, et glisser les fichiers dans un dossier où le php est actif (ex: htdocs ou www)
    
2) Pour finir, importer la base de données (MySQL) : 
