...
<h2>Paiement</h2>
<p>Vous allez procédé au paiement, merci de bien vouloir vérifier les informations</p>
<div class="row">
  <div class="col-75">
    <div class="container">
  ...
  <div class="col-25">
    <div class="container">
      ...
      <?php foreach ($maCommande->panier() as $article) { ?>
        <div class="articleLigne"> <div class='nomArti' ><a href="#"><?php echo $article->nom() ?></a></div>  <span class="price"><?php echo $article->prix()."€" ?> </span> </div>
      <?php } ?>
