        ...
        <ul class="listeCouleur">
            <?php 
                ...
                foreach ($vetement->listeCouleurDispo() as $couleur) {
                    ...
                    echo "<li > <div class='color' style='background-image:url(public/media/vetement/id".$vetement->id().".jpg); ".$couleur->filterCssCode().";".$vetement->motifPosition()."'></div> <input name='"."vet".$vetement->id()."' id='$idInput' type='radio'> <label for='$idInput' style='filter: ".$couleur->filterCssCode().";' title='".$couleur->nom()."'>  </label> </li>";
                }
